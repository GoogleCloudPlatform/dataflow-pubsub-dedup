...
public class DedupWithPubSubIO {
    private static final Logger LOG = LoggerFactory.getLogger(DedupWithPubSubIO.class);
    ...
    public static void main(String[] args) {
        ...
        psReadForDedup.apply("WriteDedupResults",
