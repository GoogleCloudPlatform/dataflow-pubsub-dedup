...
public class DedupWithState {
    private static final Logger LOG = LoggerFactory.getLogger(DedupWithState.class);
    ...
    public static void main(String[] args) {
        ...
        PCollection<Message> dedupedMsgs =
                psReadForDedup.apply("StateBasedDedup", new StateBasedDistinct())
                .apply(new AssignDfUniqueIds());

        dedupedMsgs.apply("DedupWithStateResults",
